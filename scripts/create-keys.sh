...
echo
echo
echo "After receiving tokens, you can link your oracle account to your validator by running from your validator wallet":
...
echo "And then running this from your oracle wallet":
...
echo
echo
echo "After receiving tokens, you can link your liquidator account to your validator by running from your validator wallet":
...
echo "And then running this from your liquidator wallet":
