...
echo "$DAEMON tx subaccount create-sub-account $(printf "$WALLET_PASSWORD\n" | $DAEMON keys show liquidator -a --keyring-backend file) --from val --fees 10000000$DENOM --gas 300000 --keyring-backend file -y"
echo "$DAEMON tx subaccount activate-sub-account $(printf "$WALLET_PASSWORD\n" | $DAEMON keys show val -a --keyring-backend file) --from liquidator --fees 10000000$DENOM --gas 300000 --keyring-backend file -y"
